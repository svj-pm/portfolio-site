  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#0A0A0F] via-[#1a1a2e] to-[#0A0A0F]">
        ...
        <div
          className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-accent/20 rounded-full blur-[120px] animate-pulse"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-3xl md:text-4xl lg:text-5xl font-semibold mb-8 gradient-text-blue"
          >
          ...
          <motion.div
            ...
            className="glass rounded-2xl p-8 mb-10 max-w-4xl mx-auto"
          >
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              ...
              <span className="gradient-text-purple font-semibold">$XXXM growth</span> and launched products and new
          ...
          >
            <button
              ...
              className="relative group px-10 py-5 rounded-xl font-semibold text-lg overflow-hidden"
            >
              ...
              <span className="relative text-white flex items-center justify-center gap-2 group-hover:scale-105 transition-transform">
                View My Work
              </span>
            </button>
            <button
              onClick={() => scrollToSection("contact")}
              className="relative group px-10 py-5 rounded-xl font-semibold text-lg glass hover:glass-strong transition-all"
            >
          ...
          >
            <a
              ...
              className="relative group w-14 h-14 rounded-full glass flex items-center justify-center hover:glass-strong transition-all"
              aria-label="Email"
            >
