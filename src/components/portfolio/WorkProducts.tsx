  ...
  const products = [
    {
      ...
      description:
        "Revolutionary digital annuity platform bringing retirement products directly to consumers through an intuitive, AI-powered experience.",
      features: [
    ...
    },
    {
      ...
      features: [
        "API-first card issuing infrastructure",
        "Real-time transaction processing",
        "Customizable credit card programs",
        "Advanced fraud prevention and controls",
      ],
